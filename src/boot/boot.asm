...
ReservedSectors				dw 200					;Sectors reserved for kernel
FatCopies					db 0x02					;Two copies of FAT
RootDirEntries				dw 0x40					;64 Entries
NumSectors					dw 0x00					;Can be zero
MediaType					db 0xF8
...
Signature					db 0x29
VolumeID					dd 0xD105
VolumeIDString				db 'PEACHOSBOOT'		;11 bytes
